...
namespace Oscillite.CleanRoom.LSM
{
	...
	public class TestLeadInjectorPulseWidthTraceScaleList : TraceScaleList
	{
		public TestLeadInjectorPulseWidthTraceScaleList(float probeGain, float probeOffset)
			: base(TraceProbeType.TRACE_PROBE_INJECTOR_PULSE_WIDTH, hasAutoScale: false)
		{
